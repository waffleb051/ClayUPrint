...
#define EXTRUDER_FAN_COOL_TEMP 0 //changed from 50 TT

#define EXT0_X_OFFSET 0 //Removed TT
...
#define EXT0_HEATER_PIN HEATER_0_PIN //Removed TT
#define EXT0_STEP_PIN E0_STEP_PIN //Removed TT
#define EXT0_DIR_PIN E0_DIR_PIN //Removed TT
// set to false/true for normal / inverse direction
#define EXT0_INVERSE true //Removed TT
#define EXT0_ENABLE_PIN E0_ENABLE_PIN //Removed TT
// For Inverting Stepper Enable Pins (Active Low) use 0, Non Inverting (Active High) use 1
#define EXT0_ENABLE_ON false //Removed TT
// The following speed settings are for skeinforge 40+ where e is the
// length of filament pulled inside the heater. For repsnap or older
// skeinforge use higher values.
//  Overridden if EEPROM activated.
#define EXT0_MAX_FEEDRATE 100 //Removed TT
// Feedrate from halted extruder in mm/s
//  Overridden if EEPROM activated.
#define EXT0_MAX_START_FEEDRATE 45 //Removed TT
// Acceleration in mm/s^2
//  Overridden if EEPROM activated.
#define EXT0_MAX_ACCELERATION 6500 //Removed TT
...
#define UI_PRINTER_COMPANY "SeeMeCNC (Modded)"
